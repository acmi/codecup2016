...
public abstract class SchemaFactory {
    ...
    public static final SchemaFactory newInstance(String string) {
        ...
        if (classLoader == null) {
            Class class_ = class$javax$xml$validation$SchemaFactory == null ? (SchemaFactory.class$javax$xml$validation$SchemaFactory = SchemaFactory.class$("javax.xml.validation.SchemaFactory")) : class$javax$xml$validation$SchemaFactory;
