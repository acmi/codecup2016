...
final class FactoryFinder {
        ...
        try {
            ...
            if (classLoader == null) {
                ...
                try {
                    ...
                    if (bl) {
                        Class class_2 = class$javax$xml$transform$FactoryFinder == null ? (FactoryFinder.class$javax$xml$transform$FactoryFinder = FactoryFinder.class$("javax.xml.transform.FactoryFinder")) : class$javax$xml$transform$FactoryFinder;
    ...
    static Object find(String string, String string2) throws ConfigurationError {
        ...
        block20 : {
            ...
            if (classLoader == null) {
                Class class_ = class$javax$xml$transform$FactoryFinder == null ? (FactoryFinder.class$javax$xml$transform$FactoryFinder = FactoryFinder.class$("javax.xml.transform.FactoryFinder")) : class$javax$xml$transform$FactoryFinder;
    ...
    private static Object findJarServiceProvider(String var0) throws ConfigurationError {
        ...
        if (var3_3 != null) {
            ...
            if (var2_2 == null) {
                v0 = FactoryFinder.class$javax$xml$transform$FactoryFinder == null ? (FactoryFinder.class$javax$xml$transform$FactoryFinder = FactoryFinder.class$("javax.xml.transform.FactoryFinder")) : FactoryFinder.class$javax$xml$transform$FactoryFinder;
                var3_3 = v0.getClassLoader();
                var2_2 = SecuritySupport.getResourceAsStream(var3_3, var1_1);
            }
        } else {
            v1 = FactoryFinder.class$javax$xml$transform$FactoryFinder == null ? (FactoryFinder.class$javax$xml$transform$FactoryFinder = FactoryFinder.class$("javax.xml.transform.FactoryFinder")) : FactoryFinder.class$javax$xml$transform$FactoryFinder;
