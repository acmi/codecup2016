...
implements XMLEntityResolver {
    ...
    private String getType(XMLResourceIdentifier xMLResourceIdentifier) {
        ...
        if (xMLResourceIdentifier instanceof XMLGrammarDescription && "http://www.w3.org/2001/XMLSchema".equals((xMLGrammarDescription = (XMLGrammarDescription)xMLResourceIdentifier).getGrammarType())) {
