...
extends XMLDocumentScannerImpl {
    ...
    protected boolean scanStartElement() throws IOException, XNIException {
        ...
        do {
            ...
            if (!this.isValidNameStartChar(n2) || !bl2) {
                this.reportFatalError("ElementUnterminated", new Object[]{string});
            }
    ...
    protected boolean scanStartElementAfterName() throws IOException, XNIException {
        ...
        do {
            ...
            if (!this.isValidNameStartChar(n2) || !this.fSawSpace) {
                this.reportFatalError("ElementUnterminated", new Object[]{string});
            }
            this.scanAttribute(this.fAttributes);
            this.fSawSpace = this.fEntityScanner.skipSpaces();
    ...
    static XMLDTDValidatorFilter access$000(XMLNSDocumentScannerImpl xMLNSDocumentScannerImpl) {
        return xMLNSDocumentScannerImpl.fDTDValidator;
    }
    ...
    extends XMLDocumentScannerImpl.ContentDispatcher {
        ...
        private void reconfigurePipeline() {
            if (XMLNSDocumentScannerImpl.access$000(this.this$0) == null) {
                this.this$0.fBindNamespaces = true;
            } else if (!XMLNSDocumentScannerImpl.access$000(this.this$0).hasGrammar()) {
                this.this$0.fBindNamespaces = true;
                this.this$0.fPerformValidation = XMLNSDocumentScannerImpl.access$000(this.this$0).validate();
                XMLDocumentSource xMLDocumentSource = XMLNSDocumentScannerImpl.access$000(this.this$0).getDocumentSource();
                XMLDocumentHandler xMLDocumentHandler = XMLNSDocumentScannerImpl.access$000(this.this$0).getDocumentHandler();
                xMLDocumentSource.setDocumentHandler(xMLDocumentHandler);
                if (xMLDocumentHandler != null) {
                    xMLDocumentHandler.setDocumentSource(xMLDocumentSource);
                }
                XMLNSDocumentScannerImpl.access$000(this.this$0).setDocumentSource(null);
                XMLNSDocumentScannerImpl.access$000(this.this$0).setDocumentHandler(null);
            }
        }
    }
