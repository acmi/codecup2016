...
extends BaseDVFactory {
    ...
    static void createBuiltInTypes(SymbolHash symbolHash) {
        ...
        XSSimpleTypeDecl xSSimpleTypeDecl3 = new XSSimpleTypeDecl(xSSimpleTypeDecl2, "normalizedString", "http://www.w3.org/2001/XMLSchema", 0, false, null, 21);
        xSSimpleTypeDecl3.applyFacets1(xSFacets, 16, 0);
        symbolHash.put("normalizedString", xSSimpleTypeDecl3);
        xSFacets.whiteSpace = 2;
        XSSimpleTypeDecl xSSimpleTypeDecl4 = new XSSimpleTypeDecl(xSSimpleTypeDecl3, "token", "http://www.w3.org/2001/XMLSchema", 0, false, null, 22);
        xSSimpleTypeDecl4.applyFacets1(xSFacets, 16, 0);
        symbolHash.put("token", xSSimpleTypeDecl4);
        xSFacets.whiteSpace = 2;
        xSFacets.pattern = "([a-zA-Z]{1,8})(-[a-zA-Z0-9]{1,8})*";
        XSSimpleTypeDecl xSSimpleTypeDecl5 = new XSSimpleTypeDecl(xSSimpleTypeDecl4, "language", "http://www.w3.org/2001/XMLSchema", 0, false, null, 23);
        xSSimpleTypeDecl5.applyFacets1(xSFacets, 24, 0);
        symbolHash.put("language", xSSimpleTypeDecl5);
        xSFacets.whiteSpace = 2;
        XSSimpleTypeDecl xSSimpleTypeDecl6 = new XSSimpleTypeDecl(xSSimpleTypeDecl4, "Name", "http://www.w3.org/2001/XMLSchema", 0, false, null, 25);
        xSSimpleTypeDecl6.applyFacets1(xSFacets, 16, 0, 2);
        symbolHash.put("Name", xSSimpleTypeDecl6);
        xSFacets.whiteSpace = 2;
        XSSimpleTypeDecl xSSimpleTypeDecl7 = new XSSimpleTypeDecl(xSSimpleTypeDecl6, "NCName", "http://www.w3.org/2001/XMLSchema", 0, false, null, 26);
        xSSimpleTypeDecl7.applyFacets1(xSFacets, 16, 0, 3);
        ...
        XSSimpleTypeDecl xSSimpleTypeDecl9 = new XSSimpleTypeDecl(null, "http://www.w3.org/2001/XMLSchema", 0, xSSimpleTypeDecl8, true, null);
        XSSimpleTypeDecl xSSimpleTypeDecl10 = new XSSimpleTypeDecl(xSSimpleTypeDecl9, "IDREFS", "http://www.w3.org/2001/XMLSchema", 0, false, null);
        ...
        xSFacets.minLength = 1;
        xSSimpleTypeDecl9 = new XSSimpleTypeDecl(null, "http://www.w3.org/2001/XMLSchema", 0, xSSimpleTypeDecl11, true, null);
        XSSimpleTypeDecl xSSimpleTypeDecl12 = new XSSimpleTypeDecl(xSSimpleTypeDecl9, "ENTITIES", "http://www.w3.org/2001/XMLSchema", 0, false, null);
        xSSimpleTypeDecl12.applyFacets1(xSFacets, 2, 0);
        symbolHash.put("ENTITIES", xSSimpleTypeDecl12);
        xSFacets.whiteSpace = 2;
        XSSimpleTypeDecl xSSimpleTypeDecl13 = new XSSimpleTypeDecl(xSSimpleTypeDecl4, "NMTOKEN", "http://www.w3.org/2001/XMLSchema", 0, false, null, 24);
        xSSimpleTypeDecl13.applyFacets1(xSFacets, 16, 0, 1);
        symbolHash.put("NMTOKEN", xSSimpleTypeDecl13);
        xSFacets.minLength = 1;
        xSSimpleTypeDecl9 = new XSSimpleTypeDecl(null, "http://www.w3.org/2001/XMLSchema", 0, xSSimpleTypeDecl13, true, null);
        XSSimpleTypeDecl xSSimpleTypeDecl14 = new XSSimpleTypeDecl(xSSimpleTypeDecl9, "NMTOKENS", "http://www.w3.org/2001/XMLSchema", 0, false, null);
        xSSimpleTypeDecl14.applyFacets1(xSFacets, 2, 0);
