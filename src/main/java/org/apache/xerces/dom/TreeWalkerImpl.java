...
implements TreeWalker {
    ...
    public TreeWalkerImpl(Node node, int n2, NodeFilter nodeFilter, boolean bl) {
    ...
    public void setWhatShow(int n2) {
        this.fWhatToShow = n2;
    }
    ...
    Node getParentNode(Node node) {
        ...
        short s2 = this.acceptNode(node2);
        if (s2 == 1) {
            return node2;
        }
    ...
    Node getNextSibling(Node node, Node node2) {
        ...
        if (node3 == null) {
            ...
            short s2 = this.acceptNode(node3);
            if (s2 == 3) {
                return this.getNextSibling(node3, node2);
            }
            return null;
        }
        short s3 = this.acceptNode(node3);
        if (s3 == 1) {
            return node3;
        }
        if (s3 == 3) {
