    ...
    static ClassLoader findClassLoader() throws ConfigurationError {
        ...
        do {
            if (classLoader2 == classLoader3) {
                Class class_ = class$org$apache$xml$dtm$ref$ObjectFactory == null ? (ObjectFactory.class$org$apache$xml$dtm$ref$ObjectFactory = ObjectFactory.class$("org.apache.xml.dtm.ref.ObjectFactory")) : class$org$apache$xml$dtm$ref$ObjectFactory;
    ...
    static Class findProviderClass(String string, ClassLoader classLoader, boolean bl) throws ClassNotFoundException, ConfigurationError {
        ...
        if (classLoader == null) {
            ...
            try {
                ...
                if (bl) {
                    Class class_2 = class$org$apache$xml$dtm$ref$ObjectFactory == null ? (ObjectFactory.class$org$apache$xml$dtm$ref$ObjectFactory = ObjectFactory.class$("org.apache.xml.dtm.ref.ObjectFactory")) : class$org$apache$xml$dtm$ref$ObjectFactory;
