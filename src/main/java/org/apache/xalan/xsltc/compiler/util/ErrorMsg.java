...
public final class ErrorMsg {
    ...
    public ErrorMsg(String string) {
        this._code = string;
        this._line = 0;
    }

    public ErrorMsg(Throwable throwable) {
        this._code = null;
        this._message = throwable.getMessage();
        this._line = 0;
    }

    public ErrorMsg(String string, int n2) {
        this._code = null;
        this._message = string;
        this._line = n2;
    }

    public ErrorMsg(String string, int n2, Object object) {
        this._code = string;
        this._line = n2;
        this._params = new Object[]{object};
    }

    public ErrorMsg(String string, Object object) {
        this(string);
        this._params = new Object[1];
        this._params[0] = object;
    }

    public ErrorMsg(String string, Object object, Object object2) {
        this(string);
        this._params = new Object[2];
        this._params[0] = object;
        this._params[1] = object2;
    }

    public ErrorMsg(String string, SyntaxTreeNode syntaxTreeNode) {
        this._code = string;
        this._url = this.getFileName(syntaxTreeNode);
        this._line = syntaxTreeNode.getLineNumber();
    }

    public ErrorMsg(String string, Object object, SyntaxTreeNode syntaxTreeNode) {
        this._code = string;
        this._url = this.getFileName(syntaxTreeNode);
        this._line = syntaxTreeNode.getLineNumber();
        this._params = new Object[1];
    ...
    public ErrorMsg(String string, Object object, Object object2, SyntaxTreeNode syntaxTreeNode) {
        this._code = string;
        this._url = this.getFileName(syntaxTreeNode);
        this._line = syntaxTreeNode.getLineNumber();
        this._params = new Object[2];
    ...
    public String toString() {
        String string = this._params == null ? (null != this._code ? this.getErrorMessage() : this._message) : MessageFormat.format(this.getErrorMessage(), this._params);
        return this.formatLine() + string;
    }

    public String toString(Object object) {
        Object[] arrobject = new Object[]{object.toString()};
        String string = MessageFormat.format(this.getErrorMessage(), arrobject);
        return this.formatLine() + string;
    }

    public String toString(Object object, Object object2) {
        Object[] arrobject = new Object[]{object.toString(), object2.toString()};
        String string = MessageFormat.format(this.getErrorMessage(), arrobject);
        return this.formatLine() + string;
    }
    ...
    public void setWarningError(boolean bl) {
        this._isWarningError = bl;
    }
