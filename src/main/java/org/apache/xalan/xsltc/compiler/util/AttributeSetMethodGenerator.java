...
extends MethodGenerator {
    ...
    public AttributeSetMethodGenerator(String string, ClassGen classGen) {
        super(2, Type.VOID, argTypes, argNames, string, classGen.getClassName(), new InstructionList(), classGen.getConstantPool());
    }
