...
implements a {
    ...
    static boolean isWhitespace(int n2) {
        return n2 == 32 || n2 == 9 || n2 == 13 || n2 == 10 || n2 == 12;
    }

    b disambiguateAxisOrFunction(int n2) throws Exception {
        int n3;
        for (n3 = this.yy_buffer_index; n3 < this.yy_buffer_read && XPathLexer.isWhitespace(this.yy_buffer[n3]); ++n3) {
        }
        if (n3 >= this.yy_buffer_read) {
            return new b(n2);
        }
        return this.yy_buffer[n3] == ':' && this.yy_buffer[n3 + 1] == ':' || this.yy_buffer[n3] == '(' ? this.newSymbol(n2) : this.newSymbol(28, this.yytext());
    }

    b disambiguateOperator(int n2) throws Exception {
        switch (this.last) {
            case -1: 
            case 2: 
            case 4: 
        ...
        return this.newSymbol(n2);
    }

    b disambiguateStar() throws Exception {
        switch (this.last) {
            case -1: 
            case 2: 
            case 4: 
    ...
    b newSymbol(int n2, String string) {
        this.last = n2;
        return new b(n2, string);
    }

    b newSymbol(int n2, Long l2) {
        this.last = n2;
        return new b(n2, l2);
    }

    b newSymbol(int n2, Double d2) {
        this.last = n2;
        return new b(n2, d2);
    }
    ...
    private int yy_advance() throws IOException {
        ...
        if (0 != this.yy_buffer_start) {
            int n3 = this.yy_buffer_start;
            int n4 = 0;
            while (n3 < this.yy_buffer_read) {
                this.yy_buffer[n4] = this.yy_buffer[n3];
                ++n3;
                ++n4;
            }
            this.yy_buffer_end -= this.yy_buffer_start;
            this.yy_buffer_start = 0;
            this.yy_buffer_read = n4;
            this.yy_buffer_index = n4;
            n2 = this.yy_reader.read(this.yy_buffer, this.yy_buffer_read, this.yy_buffer.length - this.yy_buffer_read);
            if (-1 == n2) {
                return 65537;
            }
            this.yy_buffer_read += n2;
        }
        while (this.yy_buffer_index >= this.yy_buffer_read) {
            if (this.yy_buffer_index >= this.yy_buffer.length) {
                this.yy_buffer = this.yy_double(this.yy_buffer);
            }
            if (-1 == (n2 = this.yy_reader.read(this.yy_buffer, this.yy_buffer_read, this.yy_buffer.length - this.yy_buffer_read))) {
                return 65537;
            }
            this.yy_buffer_read += n2;
        }
    ...
    private void yy_error(int n2, boolean bl) {
        System.out.print(this.yy_error_string[n2]);
        System.out.flush();
        if (bl) {
    ...
    private static int[][] unpackFromString(int n2, int n3, String string) {
        int n4 = -1;
        int n5 = 0;
        int n6 = 0;
    ...
    public b next_token() throws IOException, Exception {
        int n2 = 4;
        int n3 = this.yy_state_dtrans[this.yy_lexical_state];
        int n4 = -1;
        int n5 = -1;
        boolean bl = true;
        this.yy_mark_start();
        int n6 = this.yy_acpt[n3];
        if (0 != n6) {
            n5 = n3;
            this.yy_mark_end();
        }
        do {
            int n7 = bl && this.yy_at_bol ? 65536 : this.yy_advance();
            n4 = -1;
            n4 = yy_nxt[yy_rmap[n3]][yy_cmap[n7]];
            if (65537 == n7 && bl) {
            ...
            bl = true;
            n3 = this.yy_state_dtrans[this.yy_lexical_state];
            n4 = -1;
            n5 = -1;
            this.yy_mark_start();
            n6 = this.yy_acpt[n3];
