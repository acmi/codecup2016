...
public class QueryParameter {
    ...
    public QueryParameter(String string, String string2, String string3, boolean bl) {
        this.m_name = string;
        this.m_value = string2;
        this.m_output = bl;
        this.setTypeName(string3);
    }
    ...
    public void setTypeName(String string) {
        this.m_type = QueryParameter.map_type(string);
    ...
    public void setIsOutput(boolean bl) {
        this.m_output = bl;
    }

    private static int map_type(String string) {
        Integer n2;
        if (m_Typetable == null) {
        ...
        int n3 = (n2 = (Integer)m_Typetable.get(string.toUpperCase())) == null ? 1111 : n2;
        return n3;
    }
}
