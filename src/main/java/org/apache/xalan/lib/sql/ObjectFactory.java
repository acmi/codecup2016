...
final class ObjectFactory {
    ...
    static String lookUpFactoryClassName(String var0, String var1_1, String var2_2) {
        ...
        v0 = ObjectFactory.class$org$apache$xalan$lib$sql$ObjectFactory == null ? (ObjectFactory.class$org$apache$xalan$lib$sql$ObjectFactory = ObjectFactory.class$("org.apache.xalan.lib.sql.ObjectFactory")) : ObjectFactory.class$org$apache$xalan$lib$sql$ObjectFactory;
        var6_12 = v0;
        // MONITORENTER : v0
        var7_14 = false;
        var8_15 = null;
    ...
    static ClassLoader findClassLoader() throws ConfigurationError {
        ...
        do {
            if (classLoader2 == classLoader3) {
                Class class_ = class$org$apache$xalan$lib$sql$ObjectFactory == null ? (ObjectFactory.class$org$apache$xalan$lib$sql$ObjectFactory = ObjectFactory.class$("org.apache.xalan.lib.sql.ObjectFactory")) : class$org$apache$xalan$lib$sql$ObjectFactory;
    ...
    static Class findProviderClass(String string, ClassLoader classLoader, boolean bl) throws ClassNotFoundException, ConfigurationError {
        ...
        if (classLoader == null) {
            ...
            try {
                ...
                if (bl) {
                    Class class_2 = class$org$apache$xalan$lib$sql$ObjectFactory == null ? (ObjectFactory.class$org$apache$xalan$lib$sql$ObjectFactory = ObjectFactory.class$("org.apache.xalan.lib.sql.ObjectFactory")) : class$org$apache$xalan$lib$sql$ObjectFactory;
