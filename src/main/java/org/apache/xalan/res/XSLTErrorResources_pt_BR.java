...
extends ListResourceBundle {
    ...
    public static final XSLTErrorResources loadResourceBundle(String string) throws MissingResourceException {
        ...
        String string2 = XSLTErrorResources_pt_BR.getResourceSuffix(locale);
        try {
            return (XSLTErrorResources)ResourceBundle.getBundle(string + string2, locale);
        }
        catch (MissingResourceException missingResourceException) {
            try {
                return (XSLTErrorResources)ResourceBundle.getBundle(string, new Locale("pt", "BR"));
            }
