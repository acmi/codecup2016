...
public class EntityArrays {
    ...
    public static String[][] invert(String[][] arrstring) {
        String[][] arrstring2 = new String[arrstring.length][2];
        for (int i2 = 0; i2 < arrstring.length; ++i2) {
            arrstring2[i2][0] = arrstring[i2][1];
            arrstring2[i2][1] = arrstring[i2][0];
        }
        return arrstring2;
    }
}
