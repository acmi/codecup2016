...
implements Serializable {
    ...
    Node<K, V> find(K k2, boolean bl) {
        Object object;
        Node<K, V> node;
        Comparator<K> comparator = this.comparator;
        Node<K, V>[] arrnode = this.table;
        int n2 = LinkedHashTreeMap.secondaryHash(k2.hashCode());
        int n3 = n2 & arrnode.length - 1;
        Node<K, V> node2 = arrnode[n3];
        int n4 = 0;
        if (node2 != null) {
            object = comparator == NATURAL_ORDER ? (Comparable)k2 : null;
            do {
                int n5 = n4 = object != null ? object.compareTo(node2.key) : comparator.compare(k2, node2.key);
                if (n4 == 0) {
                    return node2;
                }
                Node node3 = node = n4 < 0 ? node2.left : node2.right;
                if (node == null) break;
                node2 = node;
            } while (true);
        }
        ...
        if (node2 == null) {
            ...
            node = new Node<K, V>(node2, k2, n2, (Node<K, V>)object, object.prev);
            arrnode[n3] = node;
        } else {
            node = new Node<K, V>(node2, k2, n2, (Node<K, V>)object, object.prev);
            if (n4 < 0) {
    ...
    private void rebalance(Node<K, V> node, boolean bl) {
        ...
        while (node2 != null) {
            ...
            int n7 = n6 - (n5 = (node4 = node2.right) != null ? node4.height : 0);
            if (n7 == -2) {
                node3 = node4.left;
                n4 = node3 != null ? node3.height : 0;
                n3 = n4 - (n2 = (node5 = node4.right) != null ? node5.height : 0);
                if (n3 == -1 || n3 == 0 && !bl) {
                ...
                node3 = node6.left;
                n4 = node3 != null ? node3.height : 0;
                n3 = n4 - (n2 = (node5 = node6.right) != null ? node5.height : 0);
                if (n3 == 1 || n3 == 0 && !bl) {
    ...
    static <K, V> Node<K, V>[] doubleCapacity(Node<K, V>[] arrnode) {
        ...
        for (int i2 = 0; i2 < n2; ++i2) {
            ...
            arrnode2[i2] = n3 > 0 ? avlBuilder.root() : null;
            arrnode2[i2 + n2] = n4 > 0 ? avlBuilder2.root() : null;
        }
        return arrnode2;
    }
