...
implements Serializable {
    ...
    Node<K, V> find(K k2, boolean bl) {
        ...
        if (node2 != null) {
            ...
            do {
                int n3 = n2 = object != null ? object.compareTo(node2.key) : comparator.compare(k2, node2.key);
                if (n2 == 0) {
                    return node2;
                }
        ...
        if (node2 == null) {
            ...
            node = new Node<K, V>(node2, k2, (Node<K, V>)object, object.prev);
            this.root = node;
        } else {
            node = new Node<K, V>(node2, k2, (Node<K, V>)object, object.prev);
            if (n2 < 0) {
    ...
    private void rebalance(Node<K, V> node, boolean bl) {
        ...
        while (node2 != null) {
            ...
            if (n7 == -2) {
                ...
                n3 = n4 - (n2 = (node3 = node5.right) != null ? node3.height : 0);
                if (n3 == -1 || n3 == 0 && !bl) {
                ...
                node4 = node6.left;
                n4 = node4 != null ? node4.height : 0;
                n3 = n4 - (n2 = (node3 = node6.right) != null ? node3.height : 0);
                if (n3 == 1 || n3 == 0 && !bl) {
