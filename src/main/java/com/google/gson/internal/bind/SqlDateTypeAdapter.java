...
extends TypeAdapter<java.sql.Date> {
    ...
    @Override
    public synchronized java.sql.Date read(JsonReader jsonReader) throws IOException {
    ...
    @Override
    public synchronized void write(JsonWriter jsonWriter, java.sql.Date date) throws IOException {
