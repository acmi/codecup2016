...
public interface Binder {
    public /* varargs */ void bindInterceptor(Matcher<? super Class<?>> var1, Matcher<? super Method> var2, MethodInterceptor ... var3);
    ...
    public /* varargs */ void requestStaticInjection(Class<?> ... var1);
    ...
    public <T> Provider<T> getProvider(Dependency<T> var1);
    ...
    public /* varargs */ void bindListener(Matcher<? super Binding<?>> var1, ProvisionListener ... var2);

    public Binder withSource(Object var1);

    public /* varargs */ Binder skipSources(Class ... var1);
    ...
    public void scanModulesForAnnotatedMethods(ModuleAnnotatedMethodScanner var1);
}
